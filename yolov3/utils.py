...
def draw_bbox(image, bboxes, cent, CLASSES=YOLO_COCO_CLASSES, show_label=True, show_confidence = True, Text_colors=(255,255,0), rectangle_colors='', tracking=False):   
    ...
    for i, bbox in enumerate(bboxes):
        ...
        cv2.drawMarker(image, cent[i], (0, 0, 255), cv2.MARKER_STAR, markerSize=5, thickness=2)
